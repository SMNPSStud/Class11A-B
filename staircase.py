...
box2=pygame.Rect(250,450,60,10)
box3=pygame.Rect(200,400,60,10)
box4=pygame.Rect(150,350,60,10)
box5=pygame.Rect(100,300,60,10)
box6=pygame.Rect(50,250,60,10)
carryOn = True
while carryOn:
    ...
    pygame.draw.rect(screen,(255,192,203),box6)
